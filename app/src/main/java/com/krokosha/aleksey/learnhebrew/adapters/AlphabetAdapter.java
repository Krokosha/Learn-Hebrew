package com.krokosha.aleksey.learnhebrew.adapters;
...
public class AlphabetAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        ImageView audioButton = (ImageView) itemView.findViewById(R.id.audioLetter);
...
//                mediaPlayer.setVolume(1, 1 - log1);
        ...
        if (position != Letter.getInstance().getLetters().size() - 1) {
            signRight.setImageResource(R.drawable.hand_);
        }
        if (position != 0) {
           // strelkaLeft.setImageResource(R.drawable.hand_);
        }

//package com.example.aleksey.learnhebrew.generals;
//
...
////        ivLetter.setImageResource(R.drawable.krokosha1);
//
...
//            ivLetter.setImageResource(list.get(currentLetter).getIdIRForPropis());
//        } else {
...
//
//        AlertDialog.Builder builder = new AlertDialog.Builder(BaseCheckActivity.this);
